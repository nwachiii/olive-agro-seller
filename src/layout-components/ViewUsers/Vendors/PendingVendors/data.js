...
const PendingVendorData = () => {
  ...
  const [pendingVendors, setPendingVendors] = useState(undefined);
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        console.log("Pending vendors from endpoints", res);
  ...
  }, [pendingVendors, config, count]);

  // return pendingVendors;
};

export default PendingVendorData;
...
//     cacDocument: require("../../../../assets/documents/cac-document-sample.jpg"),
//     directorsID: require("../../../../assets/documents/drivers-license-sample.jpg"),
//   },
//   {
//     id: uuid(),
//     companyAddress: {
